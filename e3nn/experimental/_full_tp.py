...
class FullTensorProduct(nn.Module):
    def __init__(
        self,
        irreps_in1: Union[o3.Irreps, o2.Irreps],
        irreps_in2: Union[o3.Irreps, o2.Irreps],
        *,
        ...
        elif isinstance(irreps_in1, o2.Irreps):
            self.context = O2Context()
        else:
            raise ValueError(f"Must be instances of o3.Irreps or o2.Irreps")
