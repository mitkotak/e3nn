...
class TensorProduct(CodeGenMixin, torch.nn.Module):
    ...
    internal_weights : bool
        whether the `e3nn.o2.TensorProduct` contains its learnable weights as a parameter
    ...
    def __init__(
        ...
        self.irreps_in1 = o2.Irreps(irreps_in1)
        self.irreps_in2 = o2.Irreps(irreps_in2)
        self.irreps_out = o2.Irreps(irreps_out)
    ...
    def visualize(
        ...
        r"""Visualize the connectivity of this `e3nn.o2.TensorProduct`
